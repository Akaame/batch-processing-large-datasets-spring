...
public class BatchConfiguration {
    ...
    @Bean
    public JpaItemWriter<Voltage> writer(EntityManagerFactory entityManagerFactory) {
        return new JpaItemWriterBuilder<Voltage>()
    ...
    @Bean
    public Step step1(JpaItemWriter<Voltage> writer) {
